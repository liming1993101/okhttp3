...
import demo.lm.viedeodemo.adapter.FragmentAdapter;
import demo.lm.viedeodemo.bean.ClassifyEntity;
import demo.lm.viedeodemo.network.Classify;
import demo.lm.viedeodemo.network.impl.ClassifyImpl;
import demo.lm.viedeodemo.view.ClassifyView;


public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,ClassifyView {
    ...
    private void initDate() {
        ...
        mClassify=new ClassifyImpl(this);
        mClassify.classifyInfo();
    }
    ...
    @Override
    public void addCategoryInfo(ClassifyEntity entity) {
